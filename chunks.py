...
class Chunk(object):
    ...
    def validate_previous_question(self, answer, time_taken, hint_requested, hint_time, id, level):
        ...
        self.history.append((right_answer, time_taken, hint_requested, hint_time, id, level))
